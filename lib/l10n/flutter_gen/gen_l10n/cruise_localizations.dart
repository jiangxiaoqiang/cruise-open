...
import 'cruise_localizations_af.dart';
import 'cruise_localizations_am.dart';
import 'cruise_localizations_ar.dart';
import 'cruise_localizations_as.dart';
import 'cruise_localizations_az.dart';
import 'cruise_localizations_be.dart';
import 'cruise_localizations_bg.dart';
import 'cruise_localizations_bn.dart';
import 'cruise_localizations_bs.dart';
import 'cruise_localizations_ca.dart';
import 'cruise_localizations_cs.dart';
import 'cruise_localizations_da.dart';
import 'cruise_localizations_de.dart';
import 'cruise_localizations_el.dart';
import 'cruise_localizations_en.dart';
import 'cruise_localizations_es.dart';
import 'cruise_localizations_et.dart';
import 'cruise_localizations_eu.dart';
import 'cruise_localizations_fa.dart';
import 'cruise_localizations_fi.dart';
import 'cruise_localizations_fil.dart';
import 'cruise_localizations_fr.dart';
import 'cruise_localizations_gl.dart';
import 'cruise_localizations_gsw.dart';
import 'cruise_localizations_gu.dart';
import 'cruise_localizations_he.dart';
import 'cruise_localizations_hi.dart';
import 'cruise_localizations_hr.dart';
import 'cruise_localizations_hu.dart';
import 'cruise_localizations_hy.dart';
import 'cruise_localizations_id.dart';
import 'cruise_localizations_is.dart';
import 'cruise_localizations_it.dart';
import 'cruise_localizations_ja.dart';
import 'cruise_localizations_ka.dart';
import 'cruise_localizations_kk.dart';
import 'cruise_localizations_km.dart';
import 'cruise_localizations_kn.dart';
import 'cruise_localizations_ko.dart';
import 'cruise_localizations_ky.dart';
import 'cruise_localizations_lo.dart';
import 'cruise_localizations_lt.dart';
import 'cruise_localizations_lv.dart';
import 'cruise_localizations_mk.dart';
import 'cruise_localizations_ml.dart';
import 'cruise_localizations_mn.dart';
import 'cruise_localizations_mr.dart';
import 'cruise_localizations_ms.dart';
import 'cruise_localizations_my.dart';
import 'cruise_localizations_nb.dart';
import 'cruise_localizations_ne.dart';
import 'cruise_localizations_nl.dart';
import 'cruise_localizations_or.dart';
import 'cruise_localizations_pa.dart';
import 'cruise_localizations_pl.dart';
import 'cruise_localizations_pt.dart';
import 'cruise_localizations_ro.dart';
import 'cruise_localizations_ru.dart';
import 'cruise_localizations_si.dart';
import 'cruise_localizations_sk.dart';
import 'cruise_localizations_sl.dart';
import 'cruise_localizations_sq.dart';
import 'cruise_localizations_sr.dart';
import 'cruise_localizations_sv.dart';
import 'cruise_localizations_sw.dart';
import 'cruise_localizations_ta.dart';
import 'cruise_localizations_te.dart';
import 'cruise_localizations_th.dart';
import 'cruise_localizations_tl.dart';
import 'cruise_localizations_tr.dart';
import 'cruise_localizations_uk.dart';
import 'cruise_localizations_ur.dart';
import 'cruise_localizations_uz.dart';
import 'cruise_localizations_vi.dart';
import 'cruise_localizations_zh.dart';
import 'cruise_localizations_zu.dart';

/// Callers can lookup localized strings with an instance of CruiseLocalizations returned
/// by `CruiseLocalizations.of(context)`.
///
/// Applications need to include `CruiseLocalizations.delegate()` in their app's
/// localizationDelegates list, and the locales they support in the app's
/// supportedLocales list. For example:
///
/// ```
/// import 'gen_l10n/cruise_localizations.dart';
///
/// return MaterialApp(
///   localizationsDelegates: CruiseLocalizations.localizationsDelegates,
///   supportedLocales: CruiseLocalizations.supportedLocales,
...
/// be consistent with the languages listed in the CruiseLocalizations.supportedLocales
/// property.
abstract class CruiseLocalizations {
  CruiseLocalizations(String locale) : localeName = intl.Intl.canonicalizedLocale(locale.toString());

  // ignore: unused_field
  final String localeName;

  static CruiseLocalizations of(BuildContext context) {
    return Localizations.of<CruiseLocalizations>(context, CruiseLocalizations);
  }

  static const LocalizationsDelegate<CruiseLocalizations> delegate = _CruiseLocalizationsDelegate();
...
class _CruiseLocalizationsDelegate extends LocalizationsDelegate<CruiseLocalizations> {
  const _CruiseLocalizationsDelegate();

  @override
  Future<CruiseLocalizations> load(Locale locale) {
    return SynchronousFuture<CruiseLocalizations>(_lookupCruiseLocalizations(locale));
  }
  ...
  @override
  bool shouldReload(_CruiseLocalizationsDelegate old) => false;
}

CruiseLocalizations _lookupCruiseLocalizations(Locale locale) {
  
// Lookup logic when language+script codes are specified.
switch (locale.languageCode) {
  case 'sr': {
  switch (locale.scriptCode) {
    case 'Latn': return CruiseLocalizationsSrLatn();
  }
  break;
}
}
...
switch (locale.languageCode) {
  ...
  switch (locale.countryCode) {
    case 'EG': return CruiseLocalizationsArEg();
        case 'JO': return CruiseLocalizationsArJo();
        case 'MA': return CruiseLocalizationsArMa();
        case 'SA': return CruiseLocalizationsArSa();
  }
  break;
}
    case 'de': {
  switch (locale.countryCode) {
    case 'AT': return CruiseLocalizationsDeAt();
        case 'CH': return CruiseLocalizationsDeCh();
  }
  break;
}
    case 'en': {
  switch (locale.countryCode) {
    case 'AU': return CruiseLocalizationsEnAu();
        case 'CA': return CruiseLocalizationsEnCa();
        case 'GB': return CruiseLocalizationsEnGb();
        case 'IE': return CruiseLocalizationsEnIe();
        case 'IN': return CruiseLocalizationsEnIn();
        case 'NZ': return CruiseLocalizationsEnNz();
        case 'SG': return CruiseLocalizationsEnSg();
        case 'ZA': return CruiseLocalizationsEnZa();
  }
  break;
}
    case 'es': {
  switch (locale.countryCode) {
    case '419': return CruiseLocalizationsEs419();
        case 'AR': return CruiseLocalizationsEsAr();
        case 'BO': return CruiseLocalizationsEsBo();
        case 'CL': return CruiseLocalizationsEsCl();
        case 'CO': return CruiseLocalizationsEsCo();
        case 'CR': return CruiseLocalizationsEsCr();
        case 'DO': return CruiseLocalizationsEsDo();
        case 'EC': return CruiseLocalizationsEsEc();
        case 'GT': return CruiseLocalizationsEsGt();
        case 'HN': return CruiseLocalizationsEsHn();
        case 'MX': return CruiseLocalizationsEsMx();
        case 'NI': return CruiseLocalizationsEsNi();
        case 'PA': return CruiseLocalizationsEsPa();
        case 'PE': return CruiseLocalizationsEsPe();
        case 'PR': return CruiseLocalizationsEsPr();
        case 'PY': return CruiseLocalizationsEsPy();
        case 'SV': return CruiseLocalizationsEsSv();
        case 'US': return CruiseLocalizationsEsUs();
        case 'UY': return CruiseLocalizationsEsUy();
        case 'VE': return CruiseLocalizationsEsVe();
  }
  break;
}
    case 'fr': {
  switch (locale.countryCode) {
    case 'CA': return CruiseLocalizationsFrCa();
        case 'CH': return CruiseLocalizationsFrCh();
  }
  break;
}
    case 'pt': {
  switch (locale.countryCode) {
    case 'BR': return CruiseLocalizationsPtBr();
        case 'PT': return CruiseLocalizationsPtPt();
  }
  break;
}
    case 'zh': {
  switch (locale.countryCode) {
    case 'CN': return CruiseLocalizationsZhCn();
        case 'HK': return CruiseLocalizationsZhHk();
        case 'TW': return CruiseLocalizationsZhTw();
  }
  break;
}
}
...
switch (locale.languageCode) {
  case 'af': return CruiseLocalizationsAf();
    case 'am': return CruiseLocalizationsAm();
    case 'ar': return CruiseLocalizationsAr();
    case 'as': return CruiseLocalizationsAs();
    case 'az': return CruiseLocalizationsAz();
    case 'be': return CruiseLocalizationsBe();
    case 'bg': return CruiseLocalizationsBg();
    case 'bn': return CruiseLocalizationsBn();
    case 'bs': return CruiseLocalizationsBs();
    case 'ca': return CruiseLocalizationsCa();
    case 'cs': return CruiseLocalizationsCs();
    case 'da': return CruiseLocalizationsDa();
    case 'de': return CruiseLocalizationsDe();
    case 'el': return CruiseLocalizationsEl();
    case 'en': return CruiseLocalizationsEn();
    case 'es': return CruiseLocalizationsEs();
    case 'et': return CruiseLocalizationsEt();
    case 'eu': return CruiseLocalizationsEu();
    case 'fa': return CruiseLocalizationsFa();
    case 'fi': return CruiseLocalizationsFi();
    case 'fil': return CruiseLocalizationsFil();
    case 'fr': return CruiseLocalizationsFr();
    case 'gl': return CruiseLocalizationsGl();
    case 'gsw': return CruiseLocalizationsGsw();
    case 'gu': return CruiseLocalizationsGu();
    case 'he': return CruiseLocalizationsHe();
    case 'hi': return CruiseLocalizationsHi();
    case 'hr': return CruiseLocalizationsHr();
    case 'hu': return CruiseLocalizationsHu();
    case 'hy': return CruiseLocalizationsHy();
    case 'id': return CruiseLocalizationsId();
    case 'is': return CruiseLocalizationsIs();
    case 'it': return CruiseLocalizationsIt();
    case 'ja': return CruiseLocalizationsJa();
    case 'ka': return CruiseLocalizationsKa();
    case 'kk': return CruiseLocalizationsKk();
    case 'km': return CruiseLocalizationsKm();
    case 'kn': return CruiseLocalizationsKn();
    case 'ko': return CruiseLocalizationsKo();
    case 'ky': return CruiseLocalizationsKy();
    case 'lo': return CruiseLocalizationsLo();
    case 'lt': return CruiseLocalizationsLt();
    case 'lv': return CruiseLocalizationsLv();
    case 'mk': return CruiseLocalizationsMk();
    case 'ml': return CruiseLocalizationsMl();
    case 'mn': return CruiseLocalizationsMn();
    case 'mr': return CruiseLocalizationsMr();
    case 'ms': return CruiseLocalizationsMs();
    case 'my': return CruiseLocalizationsMy();
    case 'nb': return CruiseLocalizationsNb();
    case 'ne': return CruiseLocalizationsNe();
    case 'nl': return CruiseLocalizationsNl();
    case 'or': return CruiseLocalizationsOr();
    case 'pa': return CruiseLocalizationsPa();
    case 'pl': return CruiseLocalizationsPl();
    case 'pt': return CruiseLocalizationsPt();
    case 'ro': return CruiseLocalizationsRo();
    case 'ru': return CruiseLocalizationsRu();
    case 'si': return CruiseLocalizationsSi();
    case 'sk': return CruiseLocalizationsSk();
    case 'sl': return CruiseLocalizationsSl();
    case 'sq': return CruiseLocalizationsSq();
    case 'sr': return CruiseLocalizationsSr();
    case 'sv': return CruiseLocalizationsSv();
    case 'sw': return CruiseLocalizationsSw();
    case 'ta': return CruiseLocalizationsTa();
    case 'te': return CruiseLocalizationsTe();
    case 'th': return CruiseLocalizationsTh();
    case 'tl': return CruiseLocalizationsTl();
    case 'tr': return CruiseLocalizationsTr();
    case 'uk': return CruiseLocalizationsUk();
    case 'ur': return CruiseLocalizationsUr();
    case 'uz': return CruiseLocalizationsUz();
    case 'vi': return CruiseLocalizationsVi();
    case 'zh': return CruiseLocalizationsZh();
    case 'zu': return CruiseLocalizationsZu();
}


  throw FlutterError(
    'CruiseLocalizations.delegate failed to load unsupported locale "$locale". This is likely '
