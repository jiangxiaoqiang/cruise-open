...
class CruiseLocalizationsFr extends CruiseLocalizations {
  CruiseLocalizationsFr([String locale = 'fr']) : super(locale);
  ...
  @override
  String get demoButtonSubtitle => 'Plat, en relief, avec contours et plus encore';
...
class CruiseLocalizationsFrCa extends CruiseLocalizationsFr {
  CruiseLocalizationsFrCa(): super('fr_CA');
...
class CruiseLocalizationsFrCh extends CruiseLocalizationsFr {
  CruiseLocalizationsFrCh(): super('fr_CH');
