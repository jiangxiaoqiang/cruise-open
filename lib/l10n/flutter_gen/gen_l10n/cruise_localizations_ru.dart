...
class CruiseLocalizationsRu extends CruiseLocalizations {
  CruiseLocalizationsRu([String locale = 'ru']) : super(locale);
  ...
  @override
  String get demoButtonSubtitle => 'Плоские, приподнятые, контурные и не только';
