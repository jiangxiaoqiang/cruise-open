...
class CruiseLocalizationsKy extends CruiseLocalizations {
  CruiseLocalizationsKy([String locale = 'ky']) : super(locale);
  ...
  @override
  String get demoButtonSubtitle => 'Түз, көтөрүлгөн, четки сызыктар жана башкалар';
