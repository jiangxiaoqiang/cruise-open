...
class CruiseLocalizationsMn extends CruiseLocalizations {
  CruiseLocalizationsMn([String locale = 'mn']) : super(locale);
  ...
  @override
  String get demoCupertinoActionSheetDescription => 'Үйлдлийн хүснэгт нь хэрэглэгчид одоогийн хам сэдэвтэй холбоотой хоёр эсвэл түүнээс дээш сонголтын багцыг харуулах тодорхой загварын сэрэмжлүүлэг юм. Үйлдлийн хүснэгт нь гарчиг, нэмэлт зурвас болон үйлдлийн жагсаалттай байж болно.';
  ...
  @override
  String get demoSnackbarsSubtitle => 'Snackbar нь дэлгэцийн доод талд зурвасыг харуулдаг';
  ...
  @override
  String get demoTooltipSubtitle => 'Удаан дарах эсвэл зөөхөд үзүүлдэг богино зурвас';
