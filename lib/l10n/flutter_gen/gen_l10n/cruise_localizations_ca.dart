...
class CruiseLocalizationsCa extends CruiseLocalizations {
  CruiseLocalizationsCa([String locale = 'ca']) : super(locale);
  ...
  @override
  String get demoBottomSheetPersistentDescription => 'Una pàgina persistent inferior mostra informació que complementa el contingut principal de l\'aplicació. A més, continua visible quan l\'usuari interacciona amb altres parts de l\'aplicació.';

  @override
  String get demoBottomSheetModalTitle => 'Pàgina modal inferior';

  @override
  String get demoBottomSheetModalDescription => 'Una pàgina modal inferior és una alternativa al menú o al diàleg i evita que l\'usuari interaccioni amb la resta de l\'aplicació.';
