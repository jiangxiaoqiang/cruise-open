...
class CruiseLocalizationsKk extends CruiseLocalizations {
  CruiseLocalizationsKk([String locale = 'kk']) : super(locale);
  ...
  @override
  String get demoActionChipDescription => 'Әрекет чиптері — негізгі мазмұнға қатысты әрекетті іске қосатын параметрлер жиынтығы. Олар пайдаланушы интерфейсінде динамикалық және мәнмәтіндік күйде көрсетілуі керек.';
  ...
  @override
  String get demoMenuAnItemWithAContextMenuButton => 'Мәнмәтіндік мәзірі бар элемент';

  @override
  String get demoMenuContextMenuItemOne => 'Мәнмәтіндік мәзірдегі бірінші элемент';

  @override
  String get demoMenuADisabledMenuItem => 'Өшірілген мәзір элементі';

  @override
  String get demoMenuContextMenuItemThree => 'Мәнмәтіндік мәзірдегі үшінші элемент';
