...
class CruiseLocalizationsDe extends CruiseLocalizations {
  CruiseLocalizationsDe([String locale = 'de']) : super(locale);
...
class CruiseLocalizationsDeAt extends CruiseLocalizationsDe {
  CruiseLocalizationsDeAt(): super('de_AT');
...
class CruiseLocalizationsDeCh extends CruiseLocalizationsDe {
  CruiseLocalizationsDeCh(): super('de_CH');
