...
class CruiseLocalizationsEl extends CruiseLocalizations {
  CruiseLocalizationsEl([String locale = 'el']) : super(locale);
  ...
  @override
  String get demoButtonSubtitle => 'Επίπεδο, ανασηκωμένο, με περίγραμμα και περισσότερα';
