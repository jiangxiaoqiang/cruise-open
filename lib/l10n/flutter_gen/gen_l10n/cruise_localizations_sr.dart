...
class CruiseLocalizationsSr extends CruiseLocalizations {
  CruiseLocalizationsSr([String locale = 'sr']) : super(locale);
...
class CruiseLocalizationsSrLatn extends CruiseLocalizationsSr {
  CruiseLocalizationsSrLatn(): super('sr_Latn');
